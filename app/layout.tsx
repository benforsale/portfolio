...
export const metadata: Metadata = {
    title: 'Khanh Toan | Personal Website',
    description:
        'Personal website of Khanh Toan — an IT student interested in technology, history, languages, geopolitics, and culture.',
};
...
export default function RootLayout({
    ...
    return (
        <html lang="en">
            ...
            {/* i will make my own
            analytics system in the future, so i will not use google analytics
            for now */}
